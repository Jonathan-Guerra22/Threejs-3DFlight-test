...
function btnSubmit(CIUDAD) {
    console.log(Date());
    console.log(CIUDAD);
    let checkboxes = document.querySelectorAll('input[id="'+CIUDAD+'"]:checked');
    if (checkboxes.length !== 0) getData(callback = setRoutes, ICAO=checkboxes[0].value);
}
// Event listener for button click
var bogotaId = document.getElementById('BOGOTA')
bogotaId.addEventListener('click', ()=>btnSubmit('BOGOTA'))

var madridId = document.getElementById('MADRID')
madridId.addEventListener('click', ()=>btnSubmit('MADRID'))

var losAngelesId = document.getElementById('LOS-ANGELES')
losAngelesId.addEventListener('click', ()=>btnSubmit('LOS-ANGELES'))
